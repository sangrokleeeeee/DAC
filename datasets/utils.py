...
def gdrive_download(root: str, file_name: str, archive_name: str, url_link: str):
    if os.path.exists(root):
        return
    file_path = os.path.join(os.path.dirname(root), archive_name)
    gdown.download(url_link, file_path, quiet=False)
